...
public class RISOAgid4 {
	...
	public static void main(String args[]) throws IOException{
		...
		LeitorArquivo leitor = new LeitorArquivo("agid4/infl.txt");
		leitor.geraPalavrasEspaco();
		List<String> conceitos = leitor.getPalavras();
		FileOutputStream file = new FileOutputStream(new File("agid4/AGID4.txt"));  
		int identificados = 0;
