...
import riso.builder.wordnet.data.*;
...
import riso.builder.wordnet.data.list.PointerTargetTreeNode;
import riso.builder.wordnet.data.list.PointerTargetTreeNodeList;
