...
import riso.builder.wordnet.data.DictionaryElement;
...
public class DictionaryToMap
{
        ...
        throws JWNLException, IOException
    {
        ...
        _destFiles = new DictionaryCatalogSet(destDirectory, riso.builder.wordnet.princeton.file.PrincetonObjectDictionaryFile.class);
    }
